...
class TestCeresSearch(unittest.TestCase):
    ...
    def test_generate_valid_movements_1(self):
        self.assertEqual(
            generate_valid_movements(index=(0,0), rows=7, columns=7),
            {((0,0), (0,1), (0,2), (0,3)),
             ((0,0), (1,0), (2,0), (3,0)),
             ((0,0), (1,1), (2,2), (3,3))}
        )
    ...
    def test_generate_valid_movements_3(self):
        self.assertEqual(
            generate_valid_movements(index=(4,9), rows=10, columns=10),
            {((4,9), (5,9), (6,9), (7,9)),
             ((4,9), (5,8), (6,7), (7,6))}
        )
    ...
    def test_generate_valid_movements_4(self):
        self.assertEqual(
            generate_valid_movements(index=(8,5), rows=10, columns=10),
            {((8,5), (8,6), (8,7), (8,8))}
        )
    ...
    def test_generate_valid_tuples_of_indices_2(self):
        self.assertEqual(
            generate_valid_tuples_of_indices(rows=4, columns=4),
            {((0,0), (0,1), (0,2), (0,3)),
             ((0,0), (1,0), (2,0), (3,0)),
             ((0,0), (1,1), (2,2), (3,3)),
             ((0,1), (1,1), (2,1), (3,1)),
    ...
    def test_is_xmas_2(self):
        self.assertFalse(
            is_xmas(self.M, ((3,1), (3,2), (3,3), (3,4)))
        )

    def test_is_xmas_3(self):
        self.assertTrue(
            is_xmas(self.M, ((1,6), (2,6), (3,6), (4,6)))
        )
    ...
    def test_is_xmas_5(self):
        self.assertTrue(
            is_xmas(self.M, ((6,4), (7,3), (8,2), (9,1)))
        )
